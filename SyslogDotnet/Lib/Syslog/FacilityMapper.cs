...
namespace SyslogDotnet.Lib.Syslog
{
    public class FacilityMapper
    {
        ...
        public static Facility ToFacility(string text, Facility defualtFacility = Facility.UserLevelMessages)
        {
            ...
            {
                { Facility.Any,                                  new string[]{ "Any", "All", "*" } },
        ...
        {
            return (Facility)Enum.ToObject(typeof(Facility), num);
        }

        public static Facility ToFacilityFromPri(int priority)
        {
            return (Facility)Enum.ToObject(typeof(Facility), priority / 8);
        }
    }
}
